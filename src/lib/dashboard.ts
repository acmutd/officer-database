...
export const DASHBOARD_CARDS: DashboardCardData[] = [
  ...
  {
    title: "Photoshoot Request Form",
    description: "Use this to schedule a date and time for a photoshoot for your division! Please submit your request in advance to allow sufficient time for and coordination with the content and media teams.",
    link: "https://acmutd.typeform.com/to/mTdYQAqH",
    minLevel: 2
  },
