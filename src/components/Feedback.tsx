...
export function FeedbackButton() {
  ...
  return (
    <button
      ...
      className="fixed bottom-8 right-8 w-16 h-16 bg-linear-to-br from-indigo-600 via-purple-600 to-pink-600 rounded-full shadow-2xl shadow-indigo-500/50 hover:shadow-indigo-500/70 hover:scale-110 transition-all duration-300 flex items-center justify-center group animate-pulse hover:animate-none"
    >
